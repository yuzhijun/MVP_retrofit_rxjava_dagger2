...
public class FragmentTabAdapter implements RadioGroup.OnCheckedChangeListener{
    ...
    private BaseActivity fragmentActivity; // Fragment所属的Activity
    ...
    public FragmentTabAdapter(BaseActivity fragmentActivity, List<Fragment> fragments, int fragmentContentId, RadioGroup rgs, int index) {
